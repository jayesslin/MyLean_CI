...
if(mysqli_num_rows($res) > 0) {
    while($row = mysqli_fetch_assoc($res)){
        ...
        $event_response_name = $row['event_response_id'];
        $event_place = $row['place'];
        $event_date =$row['start_time'];
        $event_time = $row['place_time'];
        $event_price = $row['event_fees'];
    }
}
$url = base_url();
?>
...
<div style="font-family:Roboto;width: 100%;background-color: #90C7E3">
    <form width="100%"  id="form1" name="form1" action="<?php echo $url?>/index.php/EventEdit/appendevent?type=edit&event_id=<?php echo $event_id?>" onsubmit="return appendEvent()" method="post" enctype="multipart/form-data" >
...
<div style="height:300px; ">
    <div class="pic1">
        <div style="padding: 100px 18% 40px 18%; text-align: center">
            <p style="font-size:2.4em;font-family: Roboto;color: #333333">EDITAR DE EVENTO</p>
            <p style="font-size:1.5em;text-align: center;color: #333333" ><a href="Agent_event_list.php">EVENTOS</a> &nbsp;&nbsp; EDITAR</p>
        </div>
    </div>
</div>
    ...
    <form width="100%"  id="form1" name="form1" action="Profilecontroller.php" onsubmit="return Reedit()" method="post" enctype="multipart/form-data" >
        <table style="width:100%;padding-left: 20px; background-color: #C0C0C0">
            ...
            <tr >
                <td width="50%" colspan="2">
                    <input type="text"  name="e_name" id="e_name" placeholder="Nombre del Evento" value="<?php echo $event_name?>"  style="width:98%;height:35px;font-family: Roboto;">
                </td>
            ...
            <tr>
                ...
                <td width="50%" colspan="2" >
                    <input type="text"  name="e_response_name" id="e_response_name" placeholder="Nombre del Responsable"value="<?php echo $event_response_name?>" style="width:98%;height:35px;font-family: Roboto;">
                </td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr style="margin-bottom: 10px">
                <td colspan="3" width="100%"><input  id="e_address"name="e_address"  placeholder=" Direccion del Lugar del Eventos"  value="<?php echo $event_place?>"style="width:97%;height:35px;font-family: Roboto;"></td></td>
            </tr>
        ...
        <table style="width:100%;padding-left: 20px; background-color: #C0C0C0">
            ...
            <tr style="margin-bottom: 15px">
                <td colspan="1"width="33%" ><input type="date" name="e_date" id="e_date" placeholder=" 00/00/0000" value="<?php echo $event_date?>" style="width:90%;height:35px;font-family: Roboto;"></td>
                <td colspan="1" width="33%" ><input type="time"  name="e_time" id="e_time" placeholder=" 00/00"  value="<?php echo $event_time?>"style="width:90%;height:35px;font-family: Roboto;"></td>
                <td colspan="1"width="33%"><input type="text"  name="e_price" id="e_price" placeholder=" $000.00" value="<?php echo $event_price?>" style="width:90%;height:35px;font-family: Roboto;"></td>
            </tr>
