...
if($pic_address==null){
    $pic_address ="$url/application/views/upload/default/user";
}else{
    $pic_address=  $url."application/views".$pic_address;
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div style="font-size :1.3em;padding: 7% 15% 7% 15% ;height:13rem; ">
    ...
    <table style="padding-left: 20px">
        <tr >
            <td width=" 20%" >
                <li style="margin-top: 15px;margin-bottom: 15px"><img src="<?php echo base_url(); ?>application/views/pic/conf/book-fill (1).png" style="vertical-align: middle"><p style="display:inline;text-align: left"> &nbsp; <?php echo $firstline?></p> </li>
                <li style="margin-top: 15px;margin-bottom: 15px"><img src="<?php echo base_url(); ?>application/views/pic/conf/book-fill (1).png" style="vertical-align: middle"><p style="display:inline;text-align: left"> &nbsp; <?php echo $secondline?></p> </li>
                <li style="margin-top: 15px;margin-bottom: 15px"><img src="<?php echo base_url(); ?>application/views/pic/conf/user (1).png" style="vertical-align: middle"><p style="display:inline;text-align: left"> &nbsp; <?php echo $user_name?></p> </li>
            </td>
            <td width=" 20%" >
                <li style="margin-top: 15px;margin-bottom: 15px"> <img src="<?php echo base_url(); ?>application/views/pic/conf/location_32inch.png" style="vertical-align: middle"><p style="display:inline;text-align: left"> &nbsp; <?php echo $user_address?></p> </li>
                <li style="margin-top: 15px;margin-bottom: 15px"><img src="<?php echo base_url(); ?>application/views/pic/conf/phone_32inch.png" style="vertical-align: middle"><p style="display:inline;text-align: left"> &nbsp; <?php echo $user_phone?></p> </li>
                <li style="margin-top: 15px;margin-bottom: 15px"><img src="<?php echo base_url(); ?>application/views/pic/conf/message_32inch.png" style="vertical-align: middle"><p style="display:inline;text-align: left"> &nbsp; <?php echo $name?></p> </li>
            </td>
...
<div id="modala" style="padding:  0 20% 7%  15% ; " >
    <!--<form width="100%"  id="form1" name="form1" action="<?php /*echo base_url(); */?>application/views/eventpage/Profilecontroller.php" onsubmit="return Reedit()" method="post" enctype="multipart/form-data" >
    -->    <form width="100%"  id="form1" name="form1" action="<?php echo base_url(); ?>index.php/ProfileEdit/reedit_pr" onsubmit="return Reedit()" method="post" enctype="multipart/form-data" >
...
<style>
    ...
    div.pic1{
         background: url("<?php echo base_url(); ?>application/views/pic/profilebg1.jpg")no-repeat;
         width:99%;
         height:300px;
