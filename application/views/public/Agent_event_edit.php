...
<div style="font-family:Roboto;width: 100%;background-color: #90C7E3">
    <form width="100%"  id="form1" name="form1" action="./controller/AppendEventcontroller.php?type=edit&event_id=<?php echo $event_id?>" onsubmit="return appendEvent()" method="post" enctype="multipart/form-data" >
