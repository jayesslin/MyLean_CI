...
<div style="width: 100%;">
    <table style="width: 60%; height: 150px;margin: 100px 20% 180px 20%;background-color:#C0C0C0 ">
        <div style="background-color: #90C7E3;"><p style="color: #a61717"><?php echo validation_errors(); ?><?php if(isset($err1)){echo $err1;}?></p></div>
...
<!--
<?php /*$attributes = array('onsubmit' => 'return false', 'action' => '##');*/?>
--><?php /*echo form_open('/index.php/home/signup',$attributes); */?>
    <?php echo form_open('/index.php/home/signup'); ?>
...
-->
        ...
        <table style="padding-left: 20px;">
            ...
            <tr style="margin-bottom: 10px">
                <td><input  type="text" id="email"name="email"  placeholder=" Correo"  style="width:90%;height:35px;font-family: Roboto;"></td>
                <td><input  type="password" name="password" id="password"  placeholder=" Contraseña"  style="width:90%;height:35px;font-family: Roboto;"></td>
            </tr>
            <tr style="margin:6px">
                <td><h2>Nombre</h2></td>
...
<script>
    ...
    function insert() {
       ...
       /* if(email==""||firstname==""||lastname==""||password==""||address==""||county==""||zipcode=="")
        ...
        console.log("目前的tt是"+ TT);
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>index.php/home/signup" ,
