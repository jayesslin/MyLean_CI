...
<table>
    <tr>
   <td>
       <img   style="margin-right: 50px"src="<?php echo base_url(); ?>application/views<?php echo $pic_addr?>.png">
    ...
    <td style="vertical-align: top;">
        ...
        <div style="cursor:pointer;margin-top:18px;padding-left:20px;background-color: #FF9900 ;width: 100px;">
            <img style="display:inline;vertical-align: middle"src="<?php echo base_url(); ?>application/views/pic/conf/shopingcar.png">
